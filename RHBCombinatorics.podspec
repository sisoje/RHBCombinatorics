...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of RHBCombinatorics.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/RHBCombinatorics'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Lazar Otasevic' => 'lazar.otasevic@1und1.de' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/RHBCombinatorics.git', :tag => s.version.to_s }
